...
echo "********-----*********-------*********"
echo TOY MLIR IR 
$CHPT/Ch7/bin/bin/toyc-ch7 --emit=mlir  $MLIR_TUTOR/my-practices/toy-codes/example_7.toy
echo
echo TOY MLIR IR + OPT
$CHPT/Ch7/bin/bin/toyc-ch7 --emit=mlir -opt $MLIR_TUTOR/my-practices/toy-codes/example_7.toy
